"""Launch the Phase 2 2D geometry-shape ablation across Group A / Group B / Group C and 0.5/1.9 lambda."""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run the Phase 2 2D geometry-shape ablation across Group A / Group B / Group C and 0.5/1.9 lambda."
    )
    parser.add_argument("--seed", type=int, default=42, help="Shared random seed.")
    parser.add_argument(
        "--results-dir",
        default="results/phase2_2d_geometry_shape_ablation",
        help="Dedicated output directory for the geometry-shape ablation.",
    )
...
def main():
    ...
    command = [
        ...
        "--templates-dir",
        "data/dataset_templates/ablation/phase2_2d_geometry_shape_ablation",
        "--experiments",
    ...
    print("Phase 2 experiment: 2D geometry-shape ablation across Group A / Group B / Group C and 0.5/1.9 lambda")
